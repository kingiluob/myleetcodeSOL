...
realsubject::~realsubject(){}
void realsubject::realrequest()
{
    std::cout<<"this is real request function..."<<std::endl;
}
...
{
    std::cout<<"this is pre request..."<<std::endl;
}
void proxy::afterrequest()
{
    std::cout<<"this is after request..."<<std::endl;
}
void proxy::request()
{
    prerequest();
